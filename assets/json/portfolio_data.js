/*
    ...
    Created: 07/26/2026
    Purpose: Stores data for portfolio_enhanced.html
*/
    ...
    "digital-humanities": [

        {
            ...
            body: {
                ...
                text: `My PhD dissertation and accompanying research-software project develop a framework for measuring and assessing data quality in digital literary collections before computational analysis. The project applies six data-quality metrics to editions of works by Herman Melville and Mark Twain, using a Python-based NLP pipelines and data visualizations to identify textual, metadata, and editorial differences. The complete dissertation is available through ProQuest; source code, documentation, tutorials, and reproducible analyses are available on GitHub.`,
                links: {
